...
<li id="back"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_list','_self');this.blur();">返回</a></li>
</ul>
    </div>
</div>
</div>
		...
		<table class="commonTable" cellspacing="1">
	        ...
	        <tr>
	            ...
	            <td class="tableContent">
		            <s:select list="classCode" name="classCode.id"
