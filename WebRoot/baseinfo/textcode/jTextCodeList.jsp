...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_toview','_self');this.blur();">查看</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_tocreate','_self');this.blur();">新建</a></li>
<li id="update"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_delete','_self');this.blur();">删除</a></li>
</ul>
    </div>
</div>
</div>
...
<input id="btnFind" type="button" name="btnFind" value="查询" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/textCodeAction_list','_self');this.blur();">
...
<div>
	...
	<table id="ec_table"  border="0"  cellspacing="0"  cellpadding="0"  class="tableRegion"  width="98%" >
		...
		<s:iterator value="#dataList" var="dl" status="vs">
