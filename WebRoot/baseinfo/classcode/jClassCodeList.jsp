...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/classCodeAction_tocreate','_self');this.blur();">新建</a></li>
<li id="update"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/classCodeAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/baseinfo/classCodeAction_delete','_self');this.blur();">删除</a></li>
</ul>
    </div>
</div>
</div>
