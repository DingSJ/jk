...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/packinglist/packingListAction_toview','_self');this.blur();">查看</a></li>
<li id="update"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/packinglist/packingListAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/packinglist/packingListAction_delete','_self');this.blur();">删除</a></li>
<li id="print"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/packinglist/packingListAction_print','_self');this.blur();">打印</a></li>

<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/shippingorder/shippingOrderAction_toedit','_self');this.blur();">委托</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/invoice/invoiceAction_toedit','_self');this.blur();">发票</a></li>
<li id="stat"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/finance/financeAction_toedit','_self');this.blur();">财务</a></li>
</ul>
    </div>
</div>
</div>
