...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/contract/contractProductAction_save','_self');">确定</a></li>
<li id="back"><a href="${pageContext.request.contextPath}/contract/contractAction_list">返回</a></li>
</ul>
    </div>
</div>
</div>
	...
	<tr>
		...
		<td>
			<input type="button" name="btnAdd" value="删除"
				 onclick="formSubmit('${pageContext.request.contextPath}/contract/contractProductAction_delete?id=${cp.id}','_self');">
			<input type="button" name="btnAdd" value="添加附件"
				 onclick="formSubmit('${pageContext.request.contextPath}/extcproduct/extCproductAction_tocreate?contractProduct.id=${id}&contractProduct.productNo=${cp.productNo}','_self');">
		</td>
	</tr>
</s:iterator>	
</table>
