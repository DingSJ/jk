...
<head>
	...
	<link rel="stylesheet" rev="stylesheet" type="text/css" href="/jk/skin/default/css/default.css" media="all" />
	<script type="text/javascript" src="/jk/js/common.js"></script>
    <script type="text/javascript" src="/jk/js/datepicker/WdatePicker.js"></script>
...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/contract/contractAction_save','_self');">确定</a></li>
