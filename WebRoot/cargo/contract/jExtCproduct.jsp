			...
			<div id="menubar">
				<div id="middleMenubar">
					<div id="innerMenubar">
						<div id="navMenubar">
							<ul>
								<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/contract/extCproductAction_save','_self');">确定</a></li>
			...
			<div>
								...
								<table class="commonTable_main" cellSpacing="1" id="resultTable">
									<tr class="rowTitle" align="middle">
										<td width="25" title="可以拖动下面行首,实现记录的位置移动.">
											<img src="${pageContext.request.contextPath}/images/drag.gif">
										</td>
										<td width="20">
							...
							<div
								...
								<div style="float: left;">
									<img style="margin: 0 5px 0 0;" src="${pageContext.request.contextPath}/skin/default/images/notice.gif" />
								</div>
