...
<html xmlns="http://www.w3.org/1999/xhtml">
	...
	<head>
		...
		<script type="text/javascript" src="${pageContext.request.contextPath}/js/tabledo.js"></script>

		<script type="text/javascript" src="/jk/components/jquery-ui/jquery-1.2.6.js"></script>
			...
			<div id="menubar">
				<div id="middleMenubar">
					<div id="innerMenubar">
						<div id="navMenubar">
							<ul>
<li id="save"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/extcproduct/extCproductAction_save','_self');">确定</a></li>
