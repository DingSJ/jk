...
<head>
	...
	<script type="text/javascript" src="${pageContext.request.contextPath}/js/ajax/getItems.js"></script>
...
<li id="save"><a href="#">暂存</a></li>
	...
	<li id="back">
		<a href="${pageContext.request.contextPath}/export/exportAction_list">返回</a>
	</li>
</ul>
    </div>
</div>
