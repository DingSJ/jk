...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_toview','_self');this.blur();">查看</a></li>
<li id="update"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_delete','_self');this.blur();">删除</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_submit','_self');this.blur();">上报</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_cancelsubmit','_self');this.blur();">取消</a></li>
<li id="print"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/export/exportAction_print','_self');this.blur();">打印</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/packinglist/packingListAction_tocreate','_self');this.blur();">装箱</a></li>
</ul>
    </div>
</div>
</div>
