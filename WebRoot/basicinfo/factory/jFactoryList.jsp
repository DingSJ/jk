...
<div id="innerMenubar">
    <div id="navMenubar">
<ul>
<li id="view"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_toview','_self');this.blur();">查看</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_tocreate','_self');this.blur();">新建</a></li>
<li id="update"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_toupdate','_self');this.blur();">修改</a></li>
<li id="delete"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_delete','_self');this.blur();">删除</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_start','_self');this.blur();">启用</a></li>
<li id="new"><a href="#" onclick="formSubmit('${pageContext.request.contextPath}/basicinfo/factoryAction_stop','_self');this.blur();">停用</a></li>
</ul>
    </div>
</div>
</div>
