...
<head>
    <title>模块介绍</title>
  	...
  	<link rel="stylesheet" rev="stylesheet" type="text/css" href="${pageContext.request.contextPath}/skin/default/css/main.css" media="all" />
</head>
	...
	<div class="modelDiv">
        ...
        <table class="modelTable" cellspacing="1">
        	...
        	<tr>
				...
				<td class="model_intro_right">横向模块权限控制(菜单、按钮、状态、功能点), 纵向权限控制(行政部门、职务等级、管辖部门、管辖人员)。
