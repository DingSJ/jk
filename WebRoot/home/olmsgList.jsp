...
<style> 
	.curbody{ CURSOR: url(olmsg/images/shubiao.ani);background:url(olmsg/images/pic738x571.jpg); }
...
<logic:notEmpty name="olmsgList">
		...
		<div id='ff8080813d00613e013d0067909e0009' style='position:absolute;left:122px;top:97px;z-index:1001; height:164px;background:none;' onmousedown='getFocus(this)'>
			<table border=0 cellspacing="0" cellpadding="0" width="220">
				<tr>
					<td style='cursor:move;' onmousedown="MDown(this,'ff8080813d00613e013d0067909e0009')" background="olmsg/images/C0FFE51.gif" height="45">
				...
				<tr>
					<td style='cursor:move;white-space:nowrap;' width='100%' onmousedown="MDown('ff8080813d00613e013d0067909e0009')" background="olmsg/images/C0FFE52.gif" >
						...
						<div style="float:right;width:80px;text-align:right;padding-right:7px;">
							...
							<a style='cursor:pointer;' title="编辑" onclick="msgupdate('ff8080813d00613e013d0067909e0009','edit')"><img src="olmsg/images/doc_edit.gif"/></a>
							...
							<a style='cursor:pointer;' title="删除" onclick="msgdel('ff8080813d00613e013d0067909e0009')"><img src="olmsg/images/doc_del.gif"/></a>
					...
					<td id="tagBPic" background="olmsg/images/C0FFE53.gif" height="63">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								...
								<img border="0" src="olmsg/images/2.gif">
								</td>
		...
		<div id='ff8080813d00613e013d00681494000a' style='position:absolute;left:442px;top:91px;z-index:1002; height:164px;background:none;' onmousedown='getFocus(this)'>
			<table border=0 cellspacing="0" cellpadding="0" width="220">
				<tr>
					<td style='cursor:move;' onmousedown="MDown(this,'ff8080813d00613e013d00681494000a')" background="olmsg/images/FFE7E81.gif" height="45">
				...
				<tr>
					<td style='cursor:move;white-space:nowrap;' width='100%' onmousedown="MDown('ff8080813d00613e013d00681494000a')" background="olmsg/images/FFE7E82.gif" >
						<div style="float:left;width:130px;padding-left:7px;font-family:Tahoma;color:gray;font-style : oblique;">
							2016-04-22 13:37
						</div>
						<div style="float:right;width:80px;text-align:right;padding-right:7px;">
							...
							<a style='cursor:pointer;' title="编辑" onclick="msgupdate('ff8080813d00613e013d00681494000a','edit')"><img src="olmsg/images/doc_edit.gif"/></a>
							...
							<a style='cursor:pointer;' title="删除" onclick="msgdel('ff8080813d00613e013d00681494000a')"><img src="olmsg/images/doc_del.gif"/></a>
				...
				<tr>
					<td id="tagBPic" background="olmsg/images/FFE7E83.gif" height="63">
						<table border="0" width="100%" cellspacing="0" cellpadding="0">
							<tr>
								<td width="50" align="center">
								<img border="0" src="olmsg/images/0.gif">
								</td>
								<td style="text-align:right;padding-right:8px;" nowrap>
								[备忘]
